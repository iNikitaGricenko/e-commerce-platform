...
public class KafkaConsumerConfig {
	...
	@Bean
	public ConsumerFactory<String, UserRegisteredNotificationDTO> userRegisteredNotificationConsumerFactory() {
		Map<String, Object> properties = getDefaultConsumerFactoryProperties();
		return new DefaultKafkaConsumerFactory<>(
			properties,
			new StringDeserializer(),
			new JsonDeserializer<>(UserRegisteredNotificationDTO.class)
		);
	}

	@Bean
	public ConsumerFactory<String, UserResetNotificationDTO> userResetNotificationConsumerFactory() {
		Map<String, Object> properties = getDefaultConsumerFactoryProperties();
		return new DefaultKafkaConsumerFactory<>(
			properties,
			new StringDeserializer(),
			new JsonDeserializer<>(UserResetNotificationDTO.class)
		);
	}
	...
	public ConsumerFactory<String, MulticastMessagePOJO> multicastMessageConsumerFactory() {
		...
		return new DefaultKafkaConsumerFactory<>(
			properties,
			new StringDeserializer(),
			new JsonDeserializer<>(MulticastMessagePOJO.class)
		);
	}
	...
	public ConsumerFactory<String, SubscriptionPOJO> subscriptionConsumerFactory() {
		...
		return new DefaultKafkaConsumerFactory<>(
			properties,
			new StringDeserializer(),
			new JsonDeserializer<>(SubscriptionPOJO.class)
		);
	}
	...
	public ConsumerFactory<String, TopicMessagePOJO> topicMessageConsumerFactory() {
		...
		return new DefaultKafkaConsumerFactory<>(
			properties,
			new StringDeserializer(),
			new JsonDeserializer<>(TopicMessagePOJO.class)
		);
	}
